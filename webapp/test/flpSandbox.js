		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAPUI5 Celo Product List ",
									"targetURL": "#SAPUI5CeloProductList-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"SAPUI5CeloProductList-display": {
								"semanticObject": "SAPUI5CeloProductList",
								"action": "display",
								"description": "A Fiori application with products integrated to Celo Blockchain",
								"title": "SAPUI5 Celo Product List ",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapui5celoproducts",
									"url": sap.ui.require.toUrl("sapui5celoproducts")
								}
							}
						}
					}
