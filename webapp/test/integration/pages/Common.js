sap.ui.define([
	...
	return Opa5.extend("sapui5celoproducts.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["sapui5celoproducts/localService/mockserver"], function (mockserver) {
